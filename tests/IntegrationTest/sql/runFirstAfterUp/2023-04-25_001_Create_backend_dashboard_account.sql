...
-- =============================================
DECLARE @id int
DECLARE @clientId nvarchar(255) = 'B82FF49B-FC6C-4B89-96D6-21D1FA0E4E14'
DECLARE @clientSecret nvarchar(255) = 'Kiwfhbpp3Aj2djKPuiBIpZQm0+YqJ2Ehzr81MqnQAJc=' -- D34BtxpaKSkfcKYCvxLbgKTdV8FUfRTHGPrKLawL
DECLARE @clientName nvarchar(255) = N'AHI Dashboard BE account'
...
Declare @projectId nvarchar(255) ='5b659b58-8572-40c5-8568-1c26afe22b42'
