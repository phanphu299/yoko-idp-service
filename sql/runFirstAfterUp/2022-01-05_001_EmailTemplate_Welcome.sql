DECLARE @name NVARCHAR(255) = 'Welcome Template';
DECLARE @subject NVARCHAR(255) = 'OpreX Asset Health Insights - Welcome Email';
DECLARE @type_code VARCHAR(25) = 'WELCOME';
DECLARE @type_code_name VARCHAR(250) = 'Welcome email'
                    ...
                    <tr>
                      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:Noto Sans,sans-serif;" align="left">
                        <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
                          ...
                          <p style="font-size: 14px; line-height: 150%;">Please click on the button to set new password and login.</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
