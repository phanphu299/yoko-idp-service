DECLARE @webDomain nvarchar(255) = N'https://ahs-dev01-user-fe-sea-wa.azurewebsites.net'
DECLARE @canaryDomain nvarchar(255) = N'https://ahs-dev01-user-canary-sea-wa.azurewebsites.net'
