DECLARE @name NVARCHAR(255) = 'Password changed notification email';
DECLARE @subject NVARCHAR(255) = 'OpreX Asset Health Insights - Password Changed';
DECLARE @type_code VARCHAR(25) = 'CHANGEPWSUCCESS';
DECLARE @type_code_name VARCHAR(250) = 'Change password notification email'
                    ...
                    <tr>
                      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:Noto Sans,sans-serif;" align="left">
                        <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
                          ...
                          <p style="font-size: 14px; line-height: 150%;">Your password has been changed successfully.</p>
                          <p style="font-size: 14px; line-height: 150%;"></p>
