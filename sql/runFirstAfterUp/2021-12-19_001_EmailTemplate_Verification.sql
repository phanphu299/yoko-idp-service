DECLARE @name NVARCHAR(255) = 'MFA Verification email';
DECLARE @subject NVARCHAR(255) = 'OpreX Asset Health Insights - Verify login';
DECLARE @type_code VARCHAR(25) = 'VERIFYLOGIN';
DECLARE @type_code_name VARCHAR(250) = 'Verify login email';
                    ...
                    <tr>
                      <td style="overflow-wrap:break-word;word-break:break-word;padding:10px;font-family:Noto Sans,sans-serif;" align="left">                
                        <div style="line-height: 150%; text-align: left; word-wrap: break-word;">
                          ...
                          <p style="font-size: 14px; line-height: 150%;">Please use this code to login.</p>
                        </div>
                      </td>
                    </tr>
                  </tbody>
                    ...
                    <tr>
                      ...
                      <div align="center">
                        <!--[if mso]><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="{{AccessUrl}}" style="height:37px; v-text-anchor:middle; width:177px;" arcsize="11%"  stroke="f" fillcolor="#00316c"><w:anchorlock/><center style="color:#FFFFFF;font-family:Noto Sans,sans-serif;"><![endif]-->  
                          <p class="v-button" style="box-sizing: border-box;display: inline-block;font-family:Noto Sans,sans-serif;text-decoration: none;-webkit-text-size-adjust: none;text-align: center;color: #FFFFFF; background-color: #00316c; border-radius: 4px;-webkit-border-radius: 4px; -moz-border-radius: 4px; width:auto; max-width:100%; overflow-wrap: break-word; word-break: break-word; word-wrap:break-word; mso-border-alt: none;">
                            <span style="display:block;padding:10px 20px;line-height:120%;"><span style="font-size: 14px; line-height: 16.8px;">{{Token}}</span></span>
                          </p>
