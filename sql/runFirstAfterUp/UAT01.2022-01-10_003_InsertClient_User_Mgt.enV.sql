DECLARE @webDomain nvarchar(255) = N'https://user-mgt-uat.ahi.apps.yokogawa.com'
DECLARE @canaryDomain nvarchar(255) = N'https://user-mgt-canary-uat.ahi.apps.yokogawa.com'
