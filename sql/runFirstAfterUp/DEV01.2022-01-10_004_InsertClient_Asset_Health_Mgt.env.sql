DECLARE @webDomain nvarchar(255) = N'https://ahs-dev01-asset-health-fe-sea-wa.azurewebsites.net'
DECLARE @canaryDomain nvarchar(255) = N'https://ahs-dev01-asset-health-canary-sea-wa.azurewebsites.net'
