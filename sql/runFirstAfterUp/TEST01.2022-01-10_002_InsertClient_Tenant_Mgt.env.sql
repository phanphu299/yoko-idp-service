DECLARE @webDomain nvarchar(255) = N'https://ahs-test01-tenant-fe-sea-wa.azurewebsites.net'
DECLARE @canaryDomain nvarchar(255) = N'https://ahs-test01-tenant-canary-sea-wa.azurewebsites.net'
