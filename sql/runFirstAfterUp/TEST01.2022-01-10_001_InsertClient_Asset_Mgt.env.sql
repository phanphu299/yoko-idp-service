DECLARE @webDomain nvarchar(255) = N'https://ahs-test01-ppm-fe-sea-wa.azurewebsites.net'
DECLARE @canaryDomain nvarchar(255) = N'https://ahs-test01-ppm-canary-sea-wa.azurewebsites.net'
