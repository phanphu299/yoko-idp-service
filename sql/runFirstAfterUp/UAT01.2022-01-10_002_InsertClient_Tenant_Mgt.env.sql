DECLARE @webDomain nvarchar(255) = N'https://tenant-mgt-uat.ahi.apps.yokogawa.com'
DECLARE @canaryDomain nvarchar(255) = N'https://tenant-mgt-canary-uat.ahi.apps.yokogawa.com'
