...
DECLARE @webDomain nvarchar(255) = N'https://dashboard-mgt-uat.ahi.apps.yokogawa.com'
DECLARE @canaryDomain nvarchar(255) = N'https://dashboard-mgt-canary-uat.ahi.apps.yokogawa.com'
