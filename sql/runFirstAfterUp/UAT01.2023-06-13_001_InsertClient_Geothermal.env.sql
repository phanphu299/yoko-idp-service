DECLARE @webDomain nvarchar(255) = N'https://geo-apm-uat.ahi.apps.yokogawa.com'
DECLARE @canaryDomain nvarchar(255) = N'https://geo-apm-canary-uat.ahi.apps.yokogawa.com'
