DECLARE @webDomain nvarchar(255) = N'https://asset-analytic-uat.ahi.apps.yokogawa.com'
DECLARE @canaryDomain nvarchar(255) = N'https://asset-analytic-canary-uat.ahi.apps.yokogawa.com'
