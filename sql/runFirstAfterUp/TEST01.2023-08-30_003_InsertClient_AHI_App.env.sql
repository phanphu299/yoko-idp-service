DECLARE @webDomain nvarchar(255) = N'https://ahs-test01-ahi-app-nodered-sea-wa.azurewebsites.net'
DECLARE @canaryDomain nvarchar(255) = N'https://ahs-test03-ahi-app-nodered-sea-wa.azurewebsites.net'
